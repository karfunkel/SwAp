...
public class GuiTest extends SingleFrameApplication {
    private static Log log = LogFactory.getLog(GuiTest.class);
	...
	// Use L&F and read theme from config
	try {
	...
	SpringContextFactory.getContext("conf/spring");
