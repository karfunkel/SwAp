...
/**
 * Implementation of a ViewController based on JFrame
 * 
 * @author Alexander Klein
 */

public abstract class ViewControllerFrame<C extends Container, V extends View<C>> extends JFrame implements ViewController<C> {
	protected V																		view;
	private CustomValidator<ViewControllerFrame<C, V>, ViewControllerFrame<C, V>>	validator;
	private PropertyChangeListener													validationListener;
	private CombinedConfiguration													config;

	protected ViewControllerFrame() {
		super();
	}
	 ...
	 * @param view
	 */
	public ViewControllerFrame(V view) {
		super();
		this.view = view;
	}
	...
	private void init() {
		validationListener = new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				getValidator().validate(ViewControllerFrame.this);
			}
		};
	 ...
	 */
	public Validator<ViewControllerFrame<C, V>> getValidator() {
		if (validator == null)
			validator = new CustomValidator<ViewControllerFrame<C, V>, ViewControllerFrame<C, V>>(this, getMessageKey(), getConfig());
		return validator;
	}
