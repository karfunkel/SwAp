...
public class Binder {
	...
	public static void bindIntegerField(JFormattedTextField textField, ValueModel valueModel, NumberFormat numberFormat, int emptyNumber, boolean commitOnFocusLost) {
		bindIntegerField(textField, valueModel, numberFormat, new Integer(emptyNumber), commitOnFocusLost);
	}
	...
	public static void bindLongField(JFormattedTextField textField, ValueModel valueModel, NumberFormat numberFormat, long emptyNumber) {
		bindLongField(textField, valueModel, numberFormat, emptyNumber);
	}
	...
	public static void bindLongField(JFormattedTextField textField, ValueModel valueModel, NumberFormat numberFormat, long emptyNumber, boolean commitOnFocusLost) {
		bindLongField(textField, valueModel, numberFormat, new Long(emptyNumber), commitOnFocusLost);
	}
	...
	public static void bindDoubleField(JFormattedTextField textField, ValueModel valueModel, NumberFormat numberFormat, double emptyNumber, int maxFractions) {
		bindDoubleField(textField, valueModel, numberFormat, emptyNumber, maxFractions);
	}
	...
	public static void bindCurrencyField(JFormattedTextField textField, ValueModel valueModel, NumberFormat numberFormat, double emptyNumber, int maxFractions) {
		bindCurrencyField(textField, valueModel, numberFormat, emptyNumber, maxFractions);
	}
	...
	public static void bindJSpinner(JSpinner spinner, ValueModel valueModel, int defaultValue, int minValue, int maxValue, int stepSize) {
		bindJSpinner(spinner, valueModel, new Integer(defaultValue), new Integer(minValue), new Integer(maxValue), new Integer(stepSize));
	}
			...
			if (table instanceof JXTable) {
				selectionInList = new SelectionInList<T>(listModel, selectionValueModel) {
					...
					protected T getSafeElementAt(int index) {
						return (index < 0 || index >= getSize()) ? null : super.getSafeElementAt(((JXTable) table).getFilters().convertRowIndexToModel(index));
					}
				};
			}
			else
