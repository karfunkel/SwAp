...
public class TableColumnExtWrapper extends TableColumnExt {
	private TableColumnExt	delegate;
	...
	/**
	 * @return
	 * @see org.jdesktop.swingx.table.TableColumnExt#clone()
	 */
	@Override
	public Object clone() {
	 ...
	 */
	@Override
	public void copyClientPropertiesTo(TableColumnExt copy) {
		delegate.copyClientPropertiesTo(copy);
	}
